...
if (isset($_POST['insertBakerBtn'])) {
	...
	$query = insertBaker($pdo, $_POST['firstName'], $_POST['lastName'], 
		$_POST['bakeshopLocation'], $_POST['emailAddress'], $_POST['added_by'], $_POST['last_updated']);
...
if (isset($_POST['editBakerBtn'])) {
	$query = updateBaker($pdo, $_POST['firstName'], $_POST['lastName'], 
		$_POST['bakeshopLocation'], $_POST['emailAddress'], $_POST['added_by'], $_POST['last_updated'], $_GET['bakerID']);
...
if (isset($_POST['insertNewPastryBtn'])) {
    ...
    $query = insertPastry($pdo, $bakerID, $_POST['pastryName'], 
              $_POST['doughType'], $_POST['sweetnessLevel'], $_POST['price'], $_POST['added_by'], $_POST['last_updated']);
...
if (isset($_POST['editPastryBtn'])) {
    ...
    $query = updatePastry($pdo, $bakerID, $_POST['pastryName'], 
        $_POST['doughType'], $_POST['sweetnessLevel'], $_POST['price'], $_POST['added_by'], $_POST['last_updated'], $_GET['pastriesID']);
